      ...
      <div className="launch-page">
        ...
        <LaunchCard>
          ...
          <p className="launch-card__sub">
            Verkaufschance <strong>Markus Brenner</strong> · Sportage Vision · Status Bestellung
          </p>
          <ol className="launch-kpi__hint" style={{ margin: '12px 0', paddingLeft: 20, lineHeight: 1.6 }}>
            <li>Demo starten → Verkaufschance öffnen</li>
          ...
          <div className="launch-header__actions">
            <Link to="/communication" state={{ openPilot: true }} className="launch-btn launch-btn--primary" style={{ textDecoration: 'none' }}>
              Demo starten
            </Link>
        ...
        <div className="launch-kpi-grid">
          <LaunchKpi label="Verkaufschancen" value={pilot.leads} />
