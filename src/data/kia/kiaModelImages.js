...
export function resolveKiaModelImageKey(modelKey = '') {
  ...
  if (key === 'ev5-gt' || key.includes('ev5gt') || key.includes('ev5-gt')) return 'ev5-gt';
  if (key.includes('ev5')) return 'ev5';
  if (key.includes('ev4')) return 'ev4';
  if (key.includes('ev3')) return 'ev3';
  if (key.includes('ev2')) return 'ev2';
  if (key.includes('ev6')) return 'ev6';
  if (key.includes('ev9')) return 'ev9';
