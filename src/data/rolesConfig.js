...
export const PERMISSIONS = {
  ...
  dealerConditionsEdit: 'dealer.conditions.edit',
  dealerConditionsPublish: 'dealer.conditions.publish',
...
const ROLE_PERMISSIONS = {
  ...
  dealerAdmin: [
    ...
    PERMISSIONS.dealerConditionsEdit,
    PERMISSIONS.dealerConditionsPublish,
