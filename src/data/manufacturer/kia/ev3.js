...
export const kiaEv3 = {
  ...
  trims: [
    ...
    },
    {
      ...
      availablePackages: ['ev3-p10', 'ev3-p11', 'ev3-p12', 'ev3-premium', 'ev3-technik', 'ev3-komfort'],
    },
  ],
  ...
  packages: [
    {
      id: 'ev3-p10',
      code: 'P10',
      name: 'P10 DriveWise-Park-Paket inkl. HUD',
      priceGross: 1290,
      rateDelta: 12,
      description: 'DriveWise-Park-Paket inkl. Head-Up Display',
      highlights: ['DriveWise Park', 'Head-Up Display'],
      features: ['ev3-hud', 'ev3-remote-parken'],
      availableTrims: ['gt-line'],
      aliases: ['p10', 'drivewise', 'drivewise-park'],
    },
    {
      id: 'ev3-p11',
      code: 'P11',
      name: 'P11 Comfort-Paket',
      priceGross: 1490,
      rateDelta: 14,
      description: 'Comfort-Paket (nur in Verbindung mit P10)',
      highlights: ['Comfort'],
      features: ['ev3-sitzheizung-hinten', 'ev3-heckklappe'],
      availableTrims: ['gt-line'],
      requiresPackages: ['ev3-p10'],
      aliases: ['p11', 'comfort'],
    },
    {
      id: 'ev3-p12',
      code: 'P12',
      name: 'P12 Glasdach-Paket',
      priceGross: 990,
      rateDelta: 9,
      description: 'Glasdach-Paket (nur in Verbindung mit P10 und P11)',
      highlights: ['Glasdach'],
      features: ['ev3-panorama'],
      availableTrims: ['gt-line'],
      requiresPackages: ['ev3-p10', 'ev3-p11'],
      aliases: ['p12', 'glasdach'],
    },
    {
      id: 'ev3-premium',
      name: 'Premium Paket',
  ...
  equipment: [
    ...
    { id: 'ev3-panorama', name: 'Panoramadach', standardInTrims: [], availableViaPackages: ['ev3-p12'], notAvailableInTrims: ['air', 'earth'] },
