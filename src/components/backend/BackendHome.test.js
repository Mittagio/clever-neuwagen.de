...
assert.ok(homeSource.includes('Verkaufsassistent öffnen'), 'Dashboard zeigt Verkaufsassistent öffnen');
...
assert.ok(homeSource.includes('Heute im Autohaus'), 'Dashboard zeigt Heute im Autohaus');
...
const todayIndex = renderBlock.indexOf('Heute im Autohaus');
